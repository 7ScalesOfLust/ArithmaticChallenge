...
public class GameActivity extends AppCompatActivity {
    ...
    private void setViewObjects(){
        ...
        mChoice[0] = findViewById(R.id.answer1);
        mChoice[1] = findViewById(R.id.answer2);
        mChoice[2] = findViewById(R.id.answer3);
    ...
    private void setScoreTextAndProgressBar(boolean isCorrect){
        ...
        correct.setGravity(Gravity.TOP|Gravity.CENTER_HORIZONTAL, 0, 420);
        correct.show();
    ...
    /************************************************************************
     * If current score exceeds high score, updates high score in Android
